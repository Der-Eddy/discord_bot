...
Ihr benötigt mindestens Python 3.5 + [discord.py](https://github.com/Rapptz/discord.py) für diesen Bot und einen Discord Bot Account ([Infos über Bot Accounts bei discordapp.com/developers/](https://discordapp.com/developers/applications/me)).  
